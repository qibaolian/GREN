...
class chest_Xray(imdb):
    ...
    def image_path_from_index(self, index):
        ...
        """
        image_path = os.path.join(self._data_path, 'images_affine', index)
    ...
    def gt_roidb(self):
        ...
        if self._cls_ratio != '0.0':
            cls_anno_file = osp.join(self._data_path, 'cls_annotations_' + self._cls_ratio + '_affine.json')
